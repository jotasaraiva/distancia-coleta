...
Por fim, a tabela a seguir demonstra as distâncias médias das últimas coletas para cada fazenda. Com estas informações, a distância média de coleta para o projeto total é de `r dist_med_total` m.
